...
namespace Trustlink.Ledger
{
    public sealed partial class Blockchain : UntypedActor
    {
        ...
        public static readonly uint[] GenerationAmount = { 80,70,60, 50, 40, 30, 20, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10 };
        ...
        public static readonly Block GenesisBlock = new Block
        {
            ...
            Timestamp = (new DateTime(2019, 7, 26, 11, 27, 21, DateTimeKind.Utc)).ToTimestampMS(),
            Index = 0,
        ...
        private RelayResultReason OnNewBlock(Block block)
        {
            ...
            if (block.Index == Height + 1)
            {
                ...
                foreach (Block blockToPersist in blocksToPersistList)
                {
                    ...
                    // 10 is the default among of seconds per block, while MilliSecondsPerBlock is the current
                    uint extraBlocks = (10000 - MillisecondsPerBlock) / 1000;

                    if (blocksPersisted++ < blocksToPersistList.Count - (2 + Math.Max(0, extraBlocks))) continue;
                    // Empirically calibrated for relaying the most recent 2 blocks persisted with 10 network
