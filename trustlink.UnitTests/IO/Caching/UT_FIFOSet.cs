...
namespace Trustlink.UnitTests.IO.Caching
{
    ...
    public class UT_FIFOSet
    {
        ...
        public void FIFOSetTest()
        {
            ...
            CollectionAssert.AreEqual(Enumerable.ToArray<UInt256>(set), new UInt256[] { a, c });
            ...
            CollectionAssert.AreEqual(Enumerable.ToArray<UInt256>(set), new UInt256[] { a, c, d });
            ...
            CollectionAssert.AreEqual(Enumerable.ToArray<UInt256>(set), new UInt256[] { c, d, e });
        }
        ...
        public void TestAdd()
        {
            ...
            CollectionAssert.AreEqual(Enumerable.ToArray<UInt256>(set), new UInt256[] { b });
        }
        ...
        public void TestExceptWith()
        {
            ...
            CollectionAssert.AreEqual(Enumerable.ToArray<UInt256>(set), new UInt256[] { a });
        }
    }
}
