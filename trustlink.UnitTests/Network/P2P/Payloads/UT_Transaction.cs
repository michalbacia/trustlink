...
namespace Trustlink.UnitTests.Network.P2P.Payloads
{
    [TestClass]
    public class UT_Transaction
    {
        ...
        public void Transaction_Serialize_Deserialize_Simple()
        {
            ...
            // try to deserialize
            Transaction tx2 = Trustlink.IO.Helper.AsSerializable<Transaction>(sTx);
        ...
        public void Transaction_Serialize_Deserialize_DistinctCosigners()
        {
            ...
            Assert.ThrowsException<FormatException>(() =>
                tx2 = Trustlink.IO.Helper.AsSerializable<Transaction>(sTx)
            );
            Assert.IsNull(tx2);
        }
